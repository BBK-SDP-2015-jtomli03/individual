...
/**
 * MultiplyInstruction creates an object that contains the necessary fields to compute a multiplication and store the result
...
public class MultiplyInstruction extends Instruction {
    ...
    /**
     * Creates a Multiply Instruction object and sets the label and opcode.
     *
    ...
    /**
     * Creates a MultiplyInstruction object and sets the label, opcode, register for the result, and the two registers for the operands.
     *
     * @param label the label
    ...
    /**
     * Executes the multiply instruction, placing the result in the named register.
     *
